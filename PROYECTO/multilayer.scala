...
var bank = spark.read.option("header","true").option("inferSchema", "true").format("csv").load("bank-full.csv")

//Nombres de las columnas
bank.show(0)

//Ver cómo es el esquema
bank.printSchema()
...
//val Array(training, test) = features.randomSplit(Array(0.7, 0.3), seed = 41234)

//Construir el modelo de clasificación y explique su arquitectura.
//val layers = Array[Int](16, 5, 4, 3, 2)
